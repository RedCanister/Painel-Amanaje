...
async def get_upload():
    # Campo para formulário de download de dados prontos

    # Campo para upload de arquivos de dados

    # Campo para conexão de banco de dados, agendada ou por streaming

    # Quadro para exibição de dados brutos carregados com SQL
